...
function QuizGeneratorContent() {
  ...
  const generationMode = source === 'upload' ? 'upload' : source === 'prompt' ? 'prompt' : null
  ...
  const handleGenerate = async () => {
    ...
    if (generationMode === 'prompt' && !topic.trim()) {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 mb-8">
            {generationMode === 'upload'
              ? 'Generate questions from uploaded file content'
              : 'Generate questions using your prompt'}
          </p>
          ...
          >
            {generationMode === 'prompt' ? (
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold">Enter Prompt</h2>
                ...
                <textarea
                  ...
                  placeholder="E.g., Create a medium-level quiz on World War II key events and leaders..."
              ...
              <div className="mb-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/60">PDF, PPT/PPTX, TXT, DOCX, PNG, JPG, JPEG (max 10MB)</p>
                  </div>
                </div>
                ...
                >
                  ...
                  {file ? (
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/60">PDF, TXT, PPT/PPTX, DOC/DOCX, PNG, JPG, JPEG</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <button
              ...
              disabled={loading || (generationMode === 'prompt' ? !topic.trim() : !file)}
